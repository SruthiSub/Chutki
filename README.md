...
2. This vector is then used as the input for a neural network. 
...
4. We train the model with the intents.json file and save the model in a file, which we use when we run the chatbot finally.
